 ...
 * Name: Martha Rojas Student ID: 11 2073218 Date: Dec 05th, 2023 
...
app.get("/courses", (req, res) => {
    data.getCourses().then((data) => {
        if (data.length > 0) {
            ...
            res.render("courses", { message: "no result" });
        }
    }).catch(err => {
